  ...
  return (
    <div className='cardcontents'>
      ...
      <Row xs={1} md={1} className="g-4">
        <Card.Header as="h5" className='headerforms'>User Information Form</Card.Header>
        <div className='headerformsContent'>
          <label className='lfname'>
            <p className='pfname'>First Name</p>
            <Form.Control size="text" className='fname' type="text" value={'Juan'} placeholder="Enter First Name" />
          </label>
          <label className='llname'>
            <p className='plname'>Last Name</p>
            <Form.Control size="text" className='lname' type="text" value={'Dela Cruz'}  placeholder="Enter Last Name" />
          </label>
