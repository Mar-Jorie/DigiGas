...
import imageupload from './assets/sampleimage.png';
...
const EditProd = () => {
    const [fileName, setFileName] = useState('sampleimage.png');

    const handleFileChange = (event) => {
        const file = event.target.files[0];
        setFileName(file ? file.name : 'sampleimage.png');
    };
    ...
    return (
        <div className='cardcontents'>
            <div className='usertitle'>
                <h1 className='usertitle'>Edit Product Price</h1>
            </div>
            <Row xs={1} md={1} className="g-4">
                <Card.Header as="h5" className='headerforms'>Product Information Form</Card.Header>
                    ...
                    <div className="position-relative lpassword">
                        ...
                        <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                            <Form.Control
                                ...
                                value={'Distillate fuel oil sold for use in motor vehicles that use the compression ignition engine '}
